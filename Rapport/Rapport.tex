...
Jusqu'aux années $1970$, la \emph{télédétection} servait majoritairement à l'espionnage et la cartographie, principalement réalisée par le biais d'appareils photographies emporté dans des avions.
...
\begin{itemize}
	...
	\item Difficultés d'assembler des prises de vue pour en faire des "plus grandes".
\end{itemize}
