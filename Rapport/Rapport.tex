...
\subsubsection{Format de Fichier et Méthodes de Compression}
...
Le format le plus utilisé dans l'imagerie satellite est le format GeoTIFF, ou GTiff, qui est un dérivé du format TIFF. Il est très utilisé car de par sa flexibilité et le nombre de méthodes de compression existantes.
...
L'angle de visée est variable et ce qui permet de re-photographier une zone sans avoir à attendre une période orbitale entière, durant $26$ jours pour les satellites de la famille SPOT. Dans ce cas là, il faudra en plus corriger les images pour les ramener à un angle de vue proche du \emph{nadir}, on parle alors de \emph{dépointage} d'une image.
...
Voici les caractéristiques radiométrique du satellite Pléiades :
\begin{center}
	\begin{tabular}{|c|c|c|}
	\hline
