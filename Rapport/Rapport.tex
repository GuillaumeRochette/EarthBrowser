...
La réflexion derrière la descente de gradient stochastique est que le gradient de l'ensemble est la moyenne des gradients des couples $(x,y)$ \citep{Bottou2010}.
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.425]{Images/Toy_Example.png}
...
L'algorithme de rétro-propagation \citep{Werbos1974} est souvent à tort considéré comme étant la méthode d'optimisation utilisée pour minimiser la fonction de perte.
