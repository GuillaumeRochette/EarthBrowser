...
\subsection{Calcul GPU et Framework Deep Learning}
A FAIRE
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.2]{Images/SegNets_Vegas.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.2]{Images/SegNets_Paris.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.2]{Images/SegNets_Shanghai.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.2]{Images/SegNets_Khartoum.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.2]{Images/ZNets_1983.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.2]{Images/ZNets_5000.png}
		\caption{Inférences de ZNet et ZNet2}
	\end{center}
\end{figure}

Pour cet exemple, le résultat semble toujours meilleur dans le cas où l'information reste spatialisée, en effet, le contour des bâtiments est beaucoup plus précis, même dans les cas où les bâtiments sont collés.
Il y a par ailleurs moins d'artefacts sur la route.
