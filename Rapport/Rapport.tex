...
\begin{itemize}
	\item L'extraction de \emph{features} peut se faire sur la sortie de n'importe quelle couche de n'importe quel modèle, y compris une image segmentée. Cette flexibilité permettant de décomposer l'image en \emph{features} de plus ou moins haut niveau et permettant ainsi d'observer plusieurs niveaux de similarités.
	\item 
\end{itemize}
\chapter{Conclusion}
