...
Voici le détail de l'architecture de DeconvNet, en omettant les couches de \emph{Batch Normalization} et d'activation ReLU présentes après chaque couche de convolution:
\begin{center}
	\begin{tabular}{|c|c|c|c|c|c|}
	\hline 
...
Nous avons donc décider de créer des modèles contenant 5 et 7 blocs, et nous avons remplacé les couches d'activation ReLU par des couches ELU, plus performantes.
